...
class HungarianAlgorithm:
    ...
    def main(self, matrix):
        ...
        ans_pos = self.hungarian_algorithm(matrix.copy())#Get the element position.
        ans, ans_mat = self.ans_calculation(matrix, ans_pos)#Get the minimum or maximum value and corresponding matrix.
...
if __name__ == '__main__' :
    ...
    print("The matrix is:\n", matrix)
    print(matrix[0,1])
    print(hungarian.hungarian_algorithm(matrix.copy()))
